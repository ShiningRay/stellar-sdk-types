...
export namespace Server {
    ...
    interface SingleAccountCallBuilder extends AccountCallBuilder {
        call(): Promise<AccountRecord>;
    }

    abstract class AccountCallBuilder extends CallBuilder<AccountRecord> {
        accountId(id: string): SingleAccountCallBuilder;
    }
